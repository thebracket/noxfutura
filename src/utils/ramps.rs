...
fn south_north(vb: &mut Vec<f32>, element_count: &mut u32, x: f32, y: f32, z: f32) {
    ...
    let cube_geometry = [
        ...
        */
        x0, y0, z0,    1.0, 0.0, 0.0,   tw, th,
        x0, y0, z1,    1.0, 0.0, 0.0,   tw, t0,
        x0, y1, z1,    1.0, 0.0, 0.0,   t0, t0,
        ...
        */
        x1, y0, z0,    -1.0, 0.0, 0.0,  tw, th,
        x1, y1, z1,    -1.0, 0.0, 0.0,  t0, t0,
        x1, y0, z1,    -1.0, 0.0, 0.0,  tw, t0,
...
fn east_west(vb: &mut Vec<f32>, element_count: &mut u32, x: f32, y: f32, z: f32) {
    ...
    let cube_geometry = [
        ...
        x0, y0, z0,    0.0, 0.0, -1.0,  t0, t0,
        x0, y1, z0,    0.0, 0.0, -1.0,  t0, th,*/
        x1, y0, z0,    0.0, 0.0, -1.0,  t0, t0,
        x0, y0, z0,    0.0, 0.0, -1.0,  tw, th,
        x0, y1, z0,    0.0, 0.0, -1.0,  tw, t0,
        ...
        x0, y0, z1,    0.0, 0.0, 1.0,   t0, t0,
        */
        x1, y0, z1,    0.0, 0.0, 1.0,   t0, t0,
        x0, y0, z1,    0.0, 0.0, 1.0,   tw, t0,
        x0, y1, z1,    0.0, 0.0, 1.0,   tw, th,
        ...
        // Top - slope me
        x1, y0, z1,   -1.0, 1.0, 0.0,    tw, th,
        x1, y0, z0,   -1.0, 1.0, 0.0,    tw, t0,
        x0, y1, z0,   -1.0, 1.0, 0.0,    t0, t0,
        x0, y1, z0,   -1.0, 1.0, 0.0,    t0, t0,
        x0, y1, z1,   -1.0, 1.0, 0.0,    t0, th,
        x1, y0, z1,   -1.0, 1.0, 0.0,    tw, th,
    ];
    vb.extend_from_slice(&cube_geometry);
    *element_count += 8;
...
fn west_east(vb: &mut Vec<f32>, element_count: &mut u32, x: f32, y: f32, z: f32) {
    ...
    let cube_geometry = [
        ...
        */
        ...
        // Top - needs to slope
        x1, y1, z1,   1.0, 1.0, 0.0,    tw, th,
        x1, y1, z0,   1.0, 1.0, 0.0,    tw, t0,
        x0, y0, z0,   1.0, 1.0, 0.0,    t0, t0,
        x0, y0, z0,   1.0, 1.0, 0.0,    t0, t0,
        x0, y0, z1,   1.0, 1.0, 0.0,    t0, th,
        x1, y1, z1,   1.0, 1.0, 0.0,    tw, th,
    ];
    vb.extend_from_slice(&cube_geometry);
    *element_count += 8;
