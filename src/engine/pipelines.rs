...
impl <'a> RenderPipelineBuilder<'a> {
    ...
    pub fn vf_shader(self, context : &'a Context, shader_id : usize) -> Self {
        self.vertex_shader(context, shader_id).fragment_shader(context, shader_id)
    }
    ...
    pub fn vertex_state(mut self, index_format: wgpu::IndexFormat, vbs: &'a[wgpu::VertexBufferDescriptor]) -> Self {
        self.vertex_state = Some(
