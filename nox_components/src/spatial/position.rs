...
impl Position {
    ...
    pub fn with_tile(x: usize, y: usize, z: usize, region_idx: usize, dimensions: (i32, i32, i32)) -> Self {
        Self {
            loc: Location::Tile{idx: mapidx(x,y,z)},
            region_idx,
            dimensions
        }
    }
    ...
    pub fn set_tile_loc(&mut self, pos: &(usize, usize, usize)) {
        self.loc = Location::Tile{ idx: mapidx(pos.0, pos.1, pos.2) }
    }
